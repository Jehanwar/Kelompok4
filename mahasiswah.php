    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <img src="img/poliwangi.png" alt="" height="30">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="mahasiswah.php">Mahasiswa</a>
          ...
          <div class=" modal fade" id="ModalUbah<?= $No ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form method="POST" action="aksi_crudjehan.php">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="tnama" value="<?= $data["nama"] ?>" placeholder="Masukkan Nama Kalian!">
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Kelas</label>
                      <input type="text" class="form-control" name="tkelas" value="<?= $data["kelas"] ?>" placeholder="Masukkan Kelas Kalian">
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Email</label>
                      <input type="text" class="form-control" name="temail" value="<?= $data["email"] ?>" placeholder="Masukkan Email Kalian!">
                    </div>

                    <div class="mb-3">
                      <label class="form-label">Alamat</label>
                      <input type="text" class="form-control" name="talamat" value="<?= $data["alamat"] ?>" placeholder="Masukkan Alamat Kalian!">
                    </div>
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="aksi_crudjehan.php">
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    <label class="form-label">Alamat</label>
                    <input type="text" class="form-control" name="talamat"> 
                  </div>
                </div>
                <div class="modal-footer">
