                ...
                <form method="POST" action="aksi_crud2.php">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" name="ttanggal" value="<?= $data["tanggal"] ?>" placeholder="Masukkan File!">
                    </div>

                    <div class="mb-3">
                      <label class="form-label">File</label>
                      <input type="file" class="form-control" name="tfile" value="<?= $data["file"] ?>" placeholder="Masukkan File!">
                    </div>
